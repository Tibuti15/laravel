    ...
    public function guardar(Request $request)
    {
        ...
        $validator = \Validator::make($request->all(), [
            'name_career' => [
                ...
                'string', 
                'max:255',
                'unique:career,name_career' 
            ],
            'id_fac' => 'required|exists:faculty,id_fac'
        ], [
            'name_career.required' => 'El nombre de la carrera es obligatorio.',
            'name_career.unique' => 'Este nombre de carrera ya existe.',
            'id_fac.required' => 'La facultad es obligatoria.',
            'id_fac.exists' => 'La facultad seleccionada no es válida.'
        ]);
    ...
    public function procesarEdicion(Request $request, $id)
    {
        ...
        $validator = \Validator::make($request->all(), [
            'name_career' => [
                ...
                'string',
                'max:255',
                Rule::unique('career', 'name_career')->ignore($career->id_career, 'id_career')
            ],
            'id_fac' => 'required|exists:faculty,id_fac'
        ], [
            'name_career.required' => 'El nombre de la carrera es obligatorio.',
